...
const NetflixComedyMovies = () => {
    const [topRated, setTopRated] = useState();
    const [videoID, setVidoID] = useState();
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_BASE_URL}/discover/movie?api_key=${process.env.REACT_APP_API_KEY}&with_genres=35`).then((res) => {
...
export default NetflixComedyMovies
